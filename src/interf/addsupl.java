 ...
 * @author wakdm
 */
public class addsupl extends javax.swing.JInternalFrame {
Connection con=null;
...
String contact = jTextField5.getText();
        ...
        try {
             String g= "insert into sup_table (id,name,address,email,contact) values ('"+id+"','"+name+"','"+address+"','"+email+"','"+contact+"')";
