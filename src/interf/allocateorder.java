...
public void tableload(){
        ...
        try {
            String sql= "SELECT CustomerName, EmployeeName, price FROM allocation";
       pst =con.prepareStatement(sql);
       rs=pst.executeQuery();
...
//     
     try {
            ...
            String g= "insert into allocation (CustomerName,EmployeeName,price) values ('"+cname+"','"+ename+"','"+price+"')";
  ...
  tableload();
   ...
   String price = pricebox.getText();
     ...
     try {
            ...
            String g= "UPDATE allocation SET CustomerName ='"+cname+"',EmployeeName='"+ename+"',price='"+price+"' where CustomerName='"+cname+"'";
  pst =con.prepareStatement(g);
  pst.execute();
  tableload();
