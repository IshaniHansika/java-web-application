 ...
 * @author wakdm
 */
public class updatesupl extends javax.swing.JInternalFrame {
Connection con=null;
...
String contact = jTextField5.getText();
        ...
        try {
             String g= "Update sup_table set name='"+name+"',address='"+address+"',email='"+email+"',contact='"+contact+"' where id='"+id+"'";
